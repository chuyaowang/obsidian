...
- Consider an event with prob $p$. For instance, stress-tolerant cells occur with prob $p$. How many cells should be observed before you find one? That number of observations is distributed according to a geometric distribution?
