...
It is interesting to note that the score of a match of an amino acid with itself depends on the amino acid itself because the frequency of random occurrence of an amino acid aﬀects the terms used in calculating the likelihood ratio score of alignment.
